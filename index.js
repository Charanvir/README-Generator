    ...
    return inquirer
        .prompt([
            ...
            },
            {
                type: 'input',
                name: 'description',
                message: 'Please provide a description explaining your application. You should state your motivation behind building it, the problem that is solved, why you built it and more. ',
                validate: input => {
                    if (input) {
                        return true;
                    } else {
            ...
            },
            {
                type: 'input',
                name: 'version',
                message: 'Please enter the version of your application (e.g 1.1.0): ',
                validate: input => {
                    if (input) {
                        return true;
                    } else {
